    ...
    function Graph(props) {
        ...
        _this.onClickNode = function(clickedNodeId) {
            if (_this.state.config.collapsible) {
                var disconnectedLeafNodesPartialState = graphHelper.disconnectLeafNodeConnections(
                    clickedNodeId,
                    _this.state.links,
                    _this.state.d3Links
                );
    ...
    _createClass(Graph, [
        {
            ...
            value: function componentWillReceiveProps(nextProps) {
                var newGraphElements =
                    ...
                    !_utils2.default.isDeepEqual(nextProps.data, {
                ...
                var configUpdated =
                    newConfig &&
                    !_utils2.default.isObjectEmpty(newConfig) &&
                    !_utils2.default.isDeepEqual(newConfig, this.state.config);
        ...
        },
        {
            ...
            value: function render() {
                var _graphRenderer$buildG = graphRenderer.buildGraph(
                        this.state.nodes,
                        {
